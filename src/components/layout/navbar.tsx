			...
			>
				...
				<div className="hidden md:flex items-center gap-2">
					...
					<a
						href="/resume.pdf"
						download
						className="resume-btn inline-flex items-center gap-1.5 px-3 py-1.5 rounded-md text-xs"
						role="menuitem"
					>
						⤓ Resume
					</a>
			...
			>
				...
				>
					...
					<a
						href="/resume.pdf"
						download
						className="resume-btn mt-2 w-full flex items-center justify-center gap-1.5 px-3 py-2 rounded-md text-sm"
						role="menuitem"
					>
						⤓ Download Resume
					</a>
