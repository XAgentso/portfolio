...
const GITHUB_USERNAME = "XAgentso";
    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col items-center gap-3 mb-12 text-center">
                ...
                >
                    Every commit, every push — a live look at my{" "}
                    <span style={{ color: "#a78bfa" }}>GitHub contributions</span> over
                    the past year.
                </p>
            </div>
            ...
            <div className="max-w-4xl mx-auto flex flex-col gap-6">
                <div
                    className="rounded-xl p-5 md:p-8 overflow-hidden"
                    style={{
                ...
                >
                    <p
                        className="text-xs font-mono mb-5 uppercase tracking-widest"
                        style={{ color: "rgba(167, 139, 250, 0.7)" }}
                    >
                        Contribution Heatmap · Past Year
                    </p>
