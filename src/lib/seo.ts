...
const DEFAULT_DESCRIPTION =
	"CS student from Badlapur, India building toward AI/ML, Data Science & Cybersecurity — one commit at a time.";
...
const AUTHOR = "XAgentso";
const CONTACT_EMAIL = "siddharth@example.com";
const SOCIAL_PROFILES = [
	"https://github.com/XAgentso",
	"https://www.linkedin.com/in/siddharth-singh-a94963248/",
	"https://www.instagram.com/xagentso/",
];
...
const defaultJsonLd = {
	...
	offers: {
		"@type": "Offer",
		name: "AI/ML & Cybersecurity Projects",
		description:
			"Building intelligent systems, security tools, and data pipelines as a CS student passionate about AI, ML, and cybersecurity.",
	},
	knowsAbout: [
		"Machine Learning",
